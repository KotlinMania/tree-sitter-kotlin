 ...
 * read/written fields and Kotlin function references for the callbacks.
 */
class TSLexer(
    var lookahead: Int,
    var resultSymbol: TSSymbol,
    val advance: (TSLexer, Boolean) -> Unit,
    val markEnd: (TSLexer) -> Unit,
    val getColumn: (TSLexer) -> UInt,
    val isAtIncludedRangeStart: (TSLexer) -> Boolean,
    val eof: (TSLexer) -> Boolean,
    val log: (TSLexer, String) -> Unit,
)
 ...
 * with `Any?` standing in for the opaque payload and Kotlin function references for each hook.
 */
class TSLanguageExternalScanner(
    ...
    val scan: (Any?, TSLexer, BooleanArray) -> Boolean,
    val serialize: (Any?, ByteArray) -> UInt,
    val deserialize: (Any?, ByteArray, UInt) -> Unit,
)
...
class TSLanguage internal constructor(
    ...
    val lexFn: (TSLexer, TSStateId) -> Boolean,
    val keywordLexFn: (TSLexer, TSStateId) -> Boolean,
