...
This file is the quick-reference operating contract for tree-sitter-kotlin. The longer
...
tree-sitter-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tree-sitter`](https://crates.io/crates/tree-sitter). Upstream Rust is the behavioral oracle while the
